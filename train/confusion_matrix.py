...
from Test6_mobilenet.model_v3 import mobilenet_v3_large, mobilenet_v3_small
...
class ConfusionMatrix(object):
    ...
    def summary(self):
        ...
        table.add_row(['all', Total_Precision /self.num_classes , Total_Recall/self.num_classes, Total_Specificity/self.num_classes, Total_F1/self.num_classes])
        print(table)
...
if __name__ == '__main__':
    ...
    net = shufflenet_v2_x1_0(num_classes=12).to(device)

    # load pretrain weights
    model_weight_path = "./shufflenetv2_x1_622.pth"
